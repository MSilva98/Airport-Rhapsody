...
public class PassengerHandlerTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Is full? " + p.isFull());
        ...
        System.out.println(p.removePassenger(1));
        System.out.println("Size: " + p.size());    
        System.out.println("Is empty? " + p.isEmpty());
        System.out.println("Is full? " + p.isFull());

        System.out.println(p.removePassenger(2));
        System.out.println("Size: " + p.size());    
        System.out.println("Is empty? " + p.isEmpty());
        System.out.println("Is full? " + p.isFull());

        System.out.println(p.removePassenger(4));
        System.out.println("Size: " + p.size());    
        System.out.println("Is empty? " + p.isEmpty());
        System.out.println("Is full? " + p.isFull());

        System.out.println(p.removePassenger(5));
        System.out.println("Size: " + p.size());    
        System.out.println("Is empty? " + p.isEmpty());
        System.out.println("Is full? " + p.isFull());

        System.out.println(p.removePassenger(6));
        System.out.println("Size: " + p.size());    
        System.out.println("Is empty? " + p.isEmpty());
        System.out.println("Is full? " + p.isFull());

        System.out.println(p.removePassenger(7));
        System.out.println("Size: " + p.size());    
        System.out.println("Is empty? " + p.isEmpty());
        System.out.println("Is full? " + p.isFull());
